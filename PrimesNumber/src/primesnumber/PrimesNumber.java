...
// Purpose : modify the prime number application created in chapter 5 exercise 1 to include a method named isPrime() the isPrime() method should
    // require one parameter and return a boolean value
...
import java.util.Scanner;
    public class PrimesNumber {
        ...
        public static void main(String args[]) {
            ...
            while (number != 0) {
                number = scnr.nextInt();
                System.out.printf("is the %d prime? %s %s  %s %n", number,
